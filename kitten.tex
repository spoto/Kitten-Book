...
%
\section{I diversi task Ant del compilatore Kitten}\label{sec:kitten_compilations}
%
...
Riportiamo sotto le alternative disponibili e il loro effetto. Esse verranno riviste
...
\end{description}
%
\greycomment{Si noti che solo l'ultimo task genera un compilatore Kitten completo
e lo esegue in modo da ottenere dei file eseguibili
\texttt{.class} scritti in Java bytecode.}
...
dei loro campi e
metodi. Usare tale documentazione facilita estremamente l'apprendimento
e lo sviluppo di modifiche del compilatore Kitten, come per esempio
...
%
\greycomment{Pi\'u in generale, in un linguaggio di programmazione si distinguono
...
futuro. Spesso indicheremo come \emph{statici} i primi concetti e come \emph{dinamici}
i secondi.}
...
\end{center}
poich\'e ritiene illegale assegnare ad \texttt{s}
