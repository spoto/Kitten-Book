...
Kitten comporta
la definizione del suo metodo \texttt{toDotAux()}. Come visto in questi
...
del metodo
\texttt{toDotAux()}, il comportamento di default sar\`a quello dell'omonimo
...
visibile, nel file PDF generato da dot, il sottoalbero
