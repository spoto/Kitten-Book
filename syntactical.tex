...
\vspace*{-2ex}
\begin{center}
\epsfig{file = cat2.ps, width = 3.5cm}
\end{center}
\vspace*{-2ex}
%
...
\begin{figure}[t]
\begin{center}
\epsfig{file = led_logica.ps, height = 12.5cm}
\end{center}
...
\begin{figure}[t]
\begin{center}
\epsfig{file = types_hierarchy.ps, width = 14cm}
\end{center}
...
\begin{figure}[t]
\begin{center}
\epsfig{file = expressions_hierarchy.ps, width = 15.5cm}
\end{center}
\caption{La struttura gerarchica delle classi di sintassi astratta per
...
\begin{figure}[t]
\begin{center}
\epsfig{file = commands_hierarchy.ps, width = 10cm}
\end{center}
\caption{La struttura gerarchica delle classi di sintassi astratta per
...
\begin{figure}[t]
\begin{center}
\epsfig{file = classes_hierarchy.ps, width = 11cm}
\end{center}
